...
const translations: Record<Language, Record<string, string>> = {
  ...
  zu: {
    ...
    slogan: "Umndeni Wethu Ukhonza Owakho",
    heroSubtitle: "Isevisi Zomngcwabo Ezinomusa Nezinesithunzi Kusuka Ngo-2008",
    emergency: "Usizo Lwezimo Ezidingo Ezingxamile 24/7",
    quote: "Thola Isilinganiso",
    legacyTitle: "Ifa Lobubele",
    years: "Iminyaka Yokuzinikela",
    families: "Imindeni Ekhonziwe Ngenhlonipho",
    ...
    groceryHamper: "Iphekhi Lamahala Legrosa",
